            ...
            <div class="h-100" id="leftside-menu-container" data-simplebar>
                ...
                <ul class="side-nav">
                    ...
                    <li class="side-nav-item">
                        <a  href="<?= site_url('investors') ?>"  class="side-nav-link">
                    ...
                    <li class="side-nav-item">
                        <a  href="<?= site_url('investors/investment-details') ?>"  class="side-nav-link">
                    ...
                    <li class="side-nav-item">
                        <a  href="<?= site_url('investors/my-profile') ?>"  class="side-nav-link">
                    ...
                    <li class="side-nav-item">
                       <a  href="<?= site_url('investors/monthly-interest') ?>"  class="side-nav-link">
                ...
                <ul class="list-unstyled topbar-menu float-end mb-0">
                    <li class="dropdown notification-list">
                        ...
                        <span>
                            ...
                            <span class="account-position">Investor</span>
                        </span>
                    </a>
                    <div class="dropdown-menu dropdown-menu-end dropdown-menu-animated topbar-dropdown-menu profile-dropdown">
                        ...
                        <!-- item-->
                        <a href="<?= site_url('investors/my-profile') ?>" class="dropdown-item notify-item">
