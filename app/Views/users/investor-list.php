...
<?= csrf_field(); ?>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="header-title"><?= $title.' list'; ?><span>&nbsp;&nbsp;&nbsp;<a class="btn btn-dark btn-sm" href="<?= base_url('users/create-investor') ?>"><i class="uil-plus"></i> Add</a> 
                        <?php if (!empty($users)): ?>
                             <a class="btn btn-primary btn-sm" href="<?= base_url('exporter/investor') ?>"><i class="fa-solid fa-upload"></i> Export</a>
                        <?php endif ?>
                       </span></h4>
                   <br>
                                ...
                                <?php foreach ($users as $user): ?>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <a href="<?= site_url('users/documents/').$user->id ?>" class="btn btn-warning btn-sm btn-icon" data-toggle="tooltip" title="Documents"><i class="fa-solid fa-file"></i></a>
                                            <a href="<?= site_url('users/investment-list/'.$user->id) ?>" class="btn btn-info btn-sm btn-icon" data-toggle="tooltip" title="Investments"><i class="fa-solid fa-money-check-dollar"></i></a>
