...
<div class="container-fluid">
	...
	<form action="<?= site_url('users/save-investor'); ?>" class="formSubmit">
		<div class="row">
			<div class="col-12">
				<div class="card">
					<div class="card-body">
		...
		<div class="row">
			<div class="col-12">
				<div class="card">
					<div class="card-body">
						<h4 class="header-title">Investment Details</h4><hr>
						<br>

						<div class="row mb-3">
							<div class="col-md-6">
								<label class="form-label">Introducer</label>
								<select class="js-example-basic-multiple form-control" id="select2introducer" name="introducer">
									<option value=""></option>
									<?php if (!empty($introducers)): ?>
										<?php foreach ($introducers as $introducer): ?>
											<option value="<?= $introducer->id ?>"><?= $introducer->name.' ( '.$introducer->id.' )' ?></option>
										<?php endforeach ?>
									<?php endif ?>
								</select>
							</div>
							...
							<div class="col-md-6">
								<label class="form-label">Introducer Commission <small>( % )</small></label>
								<input type="number" min="0" class="form-control" name="introducer_commission" placeholder="Enter introducer commission">
							</div>
						...
						<div class="row mb-3">
							<div class="col-md-6">
								<label class="form-label">Interest <small>( % )</small></label>
								<input type="number" min="0" class="form-control" name="interest" value="0" placeholder="Enter interest">
							</div>

							<div class="col-md-6">
								<label class="form-label">Investment Amount</label>
								<input type="number" min="0" class="form-control" value="0" name="investment_amount" placeholder="Enter investment amount">
							</div>
						</div>
						...
						<div class="row mb-3">
							<div class="col-md-6">
								...
								<input type="text" class="form-control" id="investmentDatePicker" name="investment_date" placeholder="Select investment date">
							</div>

							<div class="col-md-6">
								<label class="form-label">TDS <small>( % )</small></label>
								<input type="number" min="0" class="form-control" value="0"  name="tds" placeholder="Enter tds">
							</div>
						</div>

						<div class="row mb-3">
							<div class="col-md-6">
								<label class="form-label">Other Charges <small>( Enter other charges in amount. )</small></label>
								<input type="number" min="0" class="form-control" value="0" name="other_charges" placeholder="Enter other charges">
							</div>

							<div class="col-md-6">
								<label class="form-label">Reason of other charges</label>
								<input type="text" class="form-control"  name="reason_other_charges" value="Other Charges" placeholder="Enter reason">
							</div>
						</div>
