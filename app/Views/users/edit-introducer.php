...
<div class="container-fluid">
	...
	<form action="<?= site_url('users/update-introducer/').$details->id; ?>" class="formSubmit">
		<div class="row">
			<div class="col-12">
				<div class="card">
					<div class="card-body">
					...
					<div class="card-body">
						...
						<div class="row mb-3">
							<div class="col-md-6">
								...
								<input type="text" class="form-control" name="account_number" placeholder="Enter account number" value="<?= $details->account_number ?>">
							</div>

							<div class="col-md-6">
								<label class="form-label">Confirm Account Number</label>
								<input type="text" class="form-control" name="confirm_account_number" placeholder="Enter confirm account number" value="<?= $details->account_number ?>">
							</div>
						</div>
